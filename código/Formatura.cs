        ...
        public void Salvartxt(){
            ...
            try{
                ...
                sw.Write(data.Day+"/"+data.Month+"/"+data.Year+" "+
                         ...
                         tipoCerimonia+" "+musica.valorMusica+" "+buffet.comida.DefinirPrecoComida(quantidadeConvidados)+" "+decoracao.valorDecoracao+" "+itensMesa.valorItensMesa+" "+buffet.AdicionarFormatotxt());
